#ifndef __RENDING_PLUGIN_H_
#define  __RENDING_PLUGIN_H_
...
{
private:
	unsigned char* m_pTextureMemory;
	static RendingData* m_pInstance;
public:
	RendingData();
	~RendingData();

public:
	static RendingData* GetInstance();
	unsigned char* GetTextureMemory();
};
#endif